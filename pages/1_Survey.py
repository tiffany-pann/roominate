...
if st.session_state.survey_page == "about_you":
    ...
    study_place = st.selectbox("Where do you usually study?", ["Library", "My room", "Café", "Other"])
...
if st.session_state.survey_page == "preferences":
    ...
    study_pref = st.selectbox("Where would you prefer your roommate studies?", ["Library", "Room", "Café", "Anywhere is fine"])
